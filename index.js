...
import workImg6 from "../../public/img/photoshop.jpg"
    ...
    <section id="works">
        ...
        <div className="works-container">
            ...
            <div className="work fadeIn">
                ...
                <div className="work-sub">
                    <p className="work-ttl">Photoshop画像作成</p>
                    <p className="work-desc">Photshop<span>｜</span>自主制作</p>
                </div>
            </div>
        </div>
